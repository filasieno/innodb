#ifndef INNODB_PAGE_ZBLOB2_H_
#define INNODB_PAGE_ZBLOB2_H_

// This is a generated file! Please edit source .ksy file and use kaitai-struct-compiler to rebuild

class innodb_page_zblob2_t;
...
class innodb_page_zblob2_t : public kaitai::kstruct {

public:

    innodb_page_zblob2_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent = 0, innodb_page_zblob2_t* p__root = 0);
...
public:
    ...
    innodb_page_zblob2_t* _root() const { return m__root; }
    kaitai::kstruct* _parent() const { return m__parent; }
};

#endif  // INNODB_PAGE_ZBLOB2_H_
