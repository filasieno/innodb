...
innodb_page_zblob2_t::innodb_page_zblob2_t(kaitai::kstream* p__io, kaitai::kstruct* p__parent, innodb_page_zblob2_t* p__root) : kaitai::kstruct(p__io) {
    m__parent = p__parent;
...
void innodb_page_zblob2_t::_read() {
...
innodb_page_zblob2_t::~innodb_page_zblob2_t() {
    _clean_up();
}

void innodb_page_zblob2_t::_clean_up() {
    if (m_fil_header) {
