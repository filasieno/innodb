...
in: node to print 
*/
static void rbt_print_subtree(const ib_rbt_t *tree, const ib_rbt_node_t *node, ib_rbt_print_node print)
{
	if (node != tree->nil) {
		print(node);
...
in: tree to verfify
*/
static ibool rbt_check_ordering(const ib_rbt_t *tree)
{
...
*/
static ibool rbt_count_black_nodes(const ib_rbt_t *tree, const ib_rbt_node_t *node) 
{
	ulint result;
