...
AC_DEFUN([_PANDORA_SEARCH_LIBDL],[
  ...
  AM_CONDITIONAL(IB_HAVE_LIBDL, [test "x${ac_cv_func_dlopen}" = "xyes"])
])

AC_DEFUN([_PANDORA_IB_HAVE_LIBDL],[
...
AC_DEFUN([PANDORA_IB_HAVE_LIBDL],[
  AC_REQUIRE([_PANDORA_IB_HAVE_LIBDL])
])
