...
/// \file ha_storage.inl
/// \brief Hash storage
/// \details Provides a data structure that stores chunks of data in its own storage, avoiding duplicates. Originally created by Vasil Dimov in September 24, 2007
