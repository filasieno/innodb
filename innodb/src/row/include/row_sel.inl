...
/// \file row_sel.inl
/// \brief Inline implementations for select operations
...
IB_INLINE plan_t* sel_node_get_nth_plan(sel_node_t* node, ulint i)
{
...
/// \param node select node
IB_INLINE void sel_node_reset_cursor(sel_node_t* node)
{
...
IB_INLINE que_thr_t *open_step(que_thr_t *thr)
{
    ut_ad(thr);

    open_node_t* node = (open_node_t*)thr->run_node;
