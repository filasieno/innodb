...
#include "mem_mem.hpp"
#include "srv_srv.hpp"
#include "os_sync.hpp" /* for INNODB_RW_LOCKS_USE_ATOMICS */
...
IB_INTERN ib_int64_t	rw_s_spin_wait_count	= 0;
/** number of spin loop rounds on rw-latches,
resulted during shared (read) locks */
IB_INTERN ib_int64_t	rw_s_spin_round_count	= 0;
...
IB_INTERN ib_int64_t	rw_x_spin_wait_count	= 0;
/** number of spin loop rounds on rw-latches,
resulted during exclusive (write) locks */
IB_INTERN ib_int64_t	rw_x_spin_round_count	= 0;
