...
/// \details This module implements the two-way linear list which should be used
/// if a list is used in the database. Note that a single struct may belong
/// to two or more lists, provided that the list are given different names.
/// An example of the usage of the lists can be found in fil0fil.c. */


/// \brief This macro expands to the unnamed type definition of a struct which acts
/// as the two-way list base node.
/// \details The base node contains pointers
/// to both ends of the list and a count of nodes in the list (excluding
/// the base node from the count).
/// \param TYPE	the name of the list node data type
/// \todo FIX COMMENTS, USE TEMPLATE?
...
/*******************************************************************//**
/// \brief This macro expands to the unnamed type definition of a struct which
/// should be embedded in the nodes of the list, the node type must be a struct.
/// \details This struct contains the pointers to next and previous nodes in the list.
...
/// \brief Initializes the base node of a two-way list.
...
/// \brief Adds the node as the first element in a two-way linked list.
...
/// \brief Adds the node as the last element in a two-way linked list.
/// \param NAME list name
/// \param BASE the base node (not a pointer to it)
/// \param N    pointer to the node to be added to the list
...
/// \brief Inserts a NODE2 after NODE1 in a list.
/// \param NAME   list name
/// \param BASE   the base node (not a pointer to it)
...
#ifdef IB_LIST_DEBUG
/// \brief Invalidate the pointers in a list node.
/// \param NAME list name
...
/// \brief Removes a node from a two-way linked list.
/// \param NAME  list name
/// \param BASE  the base node (not a pointer to it)
...
/// \brief Gets the next node in a two-way list.
/// \param NAME  list name
...
/// \brief Gets the previous node in a two-way list.
/// \param NAME  list name
/// \param N     pointer to a node
...
/// \brief Alternative macro to get the number of nodes in a two-way list, i.e.,
/// its length.
/// \param BASE  the base node (not a pointer to it).
...
/// \brief Gets the first node in a two-way list.
/// \param BASE  the base node (not a pointer to it)
/// \return      first node, or NULL if the list is empty
#define UT_LIST_GET_FIRST(BASE)\
(BASE).start

/// \brief Gets the last node in a two-way list.
/// \param BASE  the base node (not a pointer to it)
/// \return      last node, or NULL if the list is empty
#define UT_LIST_GET_LAST(BASE)\
(BASE).end

/// \brief Checks the consistency of a two-way list.
