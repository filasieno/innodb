...
/// of blocks.
/// \param heap in: memory heap
/// \param top in: calculate and validate only until this top pointer in the heap is reached,
...
/// \param us_size out: allocated memory (for the user) in the heap,
/// if a NULL pointer is passed as this argument, it is ignored; in the
/// non-debug version this is always -1
/// \param ph_size out: physical size of the heap, if a NULL pointer is passed as this
/// argument, it is ignored
/// \param n_blocks out: number of blocks in the heap, if a NULL pointer is passed as this
/// argument, it is ignored
