...
/// \file lock_priv.hpp
/// \brief Lock module internal structures and methods.
/// \details Originally created by Vasil Dimov on July 12, 2007.
...
// If you need to access members of the structures defined in this file, please write appropriate functions that retrieve them and put those functions in lock/
#error Do not include lock_priv.hpp outside of the lock/ module
#endif
