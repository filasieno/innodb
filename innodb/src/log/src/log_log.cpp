 ...
 */
UNIV_INTERN void log_var_init(void)
{
 ...
 */
UNIV_INTERN void log_fsp_current_free_limit_set_and_checkpoint(ulint limit) /**< in: limit to set */
{
	ibool success;
...
///
UNIV_INTERN void log_write_low(
	byte *str, /**< in: string */
	ulint str_len
) /**< in: string length */
{
