/***********************************************************************
Copyright (c) 2009, 2025 Innobase Oy. All Rights Reserved.
...
static const ib_status_t status_vars[] = {
	{ "read_req_pending",             IB_STATUS_ULINT,   &export_vars.innodb_data_pending_reads},       // IO System related
	...
	{ "buffer_pool_current_size",     IB_STATUS_ULINT,   &export_vars.innodb_buffer_pool_pages_total},  // Buffer pool related
	...
	{ "double_write_pages_written",   IB_STATUS_ULINT,   &export_vars.innodb_dblwr_pages_written},     // Double writer related
	{ "double_write_invoked",         IB_STATUS_ULINT,   &export_vars.innodb_dblwr_writes},
	{ "log_buffer_slot_waits",        IB_STATUS_ULINT,   &export_vars.innodb_log_waits}, 	           // Log related
	...
	{ "lock_row_waits",               IB_STATUS_ULINT,   &export_vars.innodb_row_lock_waits},          // Lock related
	...
	{ "row_total_read",               IB_STATUS_ULINT,   &export_vars.innodb_rows_read},               // Row operations
...
ib_status_get_all() 
out: pointer to array of strings
	...
	if (err == DB_SUCCESS) {
		...
		case IB_STATUS_I64:
			*dst = *(ib_int64_t*) var->val;
			break;
		default:
			// Currently the status variables are all INTs. 
			// Ifwe add other types then this will signal to the user
