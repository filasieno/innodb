...
UNIV_INTERN
ibool
ib_handle_errors(enum db_err* new_err, trx_t* trx, que_thr_t* thr, trx_savept_t* savept);
...
UNIV_INTERN
enum db_err
ib_trx_lock_table_with_retry(trx_t* trx, dict_table_t* table, enum lock_mode mode);
...
UNIV_INTERN
void
ib_update_statistics_if_needed(dict_table_t* table);
