...
UNIV_INTERN
void
ib_ucode_get_charset_width(const charset_t* cs, ulint* mbminlen, ulint* mbmaxlen);
...
UNIV_INTERN
ulint
ib_ucode_get_storage_size(const charset_t* cs, ulint prefix_len, ulint str_len, const char* str);
...
UNIV_INTERN
int
ib_utf8_strcasecmp(const char* a, const char* b);
...
UNIV_INTERN
int
ib_utf8_isspace(const charset_t* cs, char c);
...
UNIV_INTERN
void
ib_utf8_convert_from_table_id(const charset_t* cs, char* to, const char* from, ulint to_len);
					should be at least
					5 * strlen(to) + 1 */
...
UNIV_INTERN
void
ib_utf8_convert_from_id(const charset_t* cs, char* to, const char* from, ulint to_len);
