...
///
/// @brief Releases the item in the slot given.
/// @param mtr in: mtr
...
///
/// @brief Releases the mlocks and other objects stored in an mtr memo. They are released
...
///
/// @brief Writes the contents of a mini-transaction log, if any, to the database log.
/// @param mtr in: mtr
...
/// @param ptr in: pointer from where to read
...
/// @param mtr in: mtr
/// @param ptr in: pointer to buffer frame
