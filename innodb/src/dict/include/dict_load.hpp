...
/// \details Adds all these to the data dictionary cache. Also loads all foreign key constraints where the foreign key is in the table or where a foreign key references columns in this table.
